...
.navbar
  ...
  .site-name
    ...
    position relative
    // background-image: linear-gradient(to right, #5bd497, orange, #518e6c, green, #afea1e, green, yellow, orange, #215459, orange, yellow, green, blue, green, yellow, orange, #a340d6);    
